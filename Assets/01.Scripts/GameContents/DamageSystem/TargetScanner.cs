...
public class TargetScanner
{
    ...
    public Player Detect(Transform detector, bool useHeightDifference = true)
    {
        ...
        Vector3 toPlayer = CharacterManager.Instance.Player.transform.position - eyePos;
        Vector3 toPlayerTop = CharacterManager.Instance.Player.transform.position + Vector3.up * 1.5f - eyePos;
        ...
        if (toPlayerFlat.sqrMagnitude <= detectionRadius * detectionRadius)
        {
                ...
                Mathf.Cos(detectionAngle * 0.5f * Mathf.Deg2Rad))
            {
                ...
                if (canSee)
                    return CharacterManager.Instance.Player;
            }
        }
